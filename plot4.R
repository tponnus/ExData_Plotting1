...
plotnumeric1<-as.numeric(requireddata$Global_active_power)
plotnumeric2<-as.numeric(requireddata$Global_reactive_power)
...
par(mfrow=c(2,2))
##R1C1
plot(dtmergetm,plotnumeric1,type = "l",col="black",xlab = "", ylab = "Global Active Power")
##R1C2
plot(dtmergetm, Voltage, type = "l",xlab = "datetime", ylab = "Voltage")
##R2C1
...
##R2C2
plot(dtmergetm,plotnumeric2,type="l",col="black",xlab="datetime",ylab="Global_reactive_power")
dev.off()
